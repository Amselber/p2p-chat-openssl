...
void test_node_add_new(void) {
  node_t *n = node_add(FP1, FP1_NAME, 5);
...
void test_node_add_two_different(void) {
  node_t *a = node_add(FP1, FP1_NAME, 5);
  node_t *b = node_add(FP2, FP2_NAME, 6);
...
void test_node_find_by_fd_found(void) {
  node_add(FP1, FP1_NAME, 10);
  node_add(FP2, FP2_NAME, 20);
...
void test_node_each_iterates_all(void) {
  node_add(FP1, FP1_NAME, 1);
  node_add(FP2, FP2_NAME, 2);
  node_add(FP3, FP3_NAME, 3);
...
void test_node_fd_minus_one(void) {
  node_t *n = node_add(FP1, FP1_NAME, -1);
  TEST_ASSERT_NOT_NULL(n);
